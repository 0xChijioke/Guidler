...
import { updateGuidler } from "./helpers/updateGuidler";
import { updateYourcollectables } from "./helpers/updateYourcollectables";
...
function App(props) {
  ...
  useEffect(() => {
    updateGuidler(readContracts, address, setYourGuidler);
  }, [address, readContracts, yourGuidlerBalance]);
                      ...
                      <Flex my={2} alignItems={"center"} justify={"center"} direction={"column"}>
                        ...
                        <Flex direction={"column"} alignItems={"center"} w={"fit-content"}>
                          ...
                          <Flex direction={"row"} justify={"center"} align={"center"}>
                            ...
                            <Address address={readContracts.Noob.address} blockExplorer={blockExplorer} fontSize={16} />
                          </Flex>
